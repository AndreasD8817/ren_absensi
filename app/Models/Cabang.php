    ...
    public function insert($data) {
        try {
            $stmt = $this->db->prepare("
                INSERT INTO cabang (nama_cabang, timezone, latitude, longitude, radius_meter, denda_1_5, denda_6_10, denda_11_15, denda_16_30, denda_31_60, denda_alfa, denda_tidak_absen_pulang, tarif_lembur_per_jam)
                VALUES (:nama, :timezone, :lat, :lng, :radius, :d1, :d2, :d3, :d4, :d5, :dalfa, :dnotpulang, :lembur)
            ");
